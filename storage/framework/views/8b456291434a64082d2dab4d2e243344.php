...
<body>
    ...
    <main style="height: 100vh;" class="d-flex justify-content-center align-items-center flex-column gap-3 h-full">
        ...
        <a class="btn btn-primary" href="<?php echo e(route('home')); ?>">BacK Home</a>
    
    </main>
    
</body>
</html><?php /**PATH C:\laragon\www\CarManagementSystem\resources\views/pages/thankyoupage.blade.php ENDPATH**/ ?>