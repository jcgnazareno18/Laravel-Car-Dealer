...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                <a class="btn btn-primary" href="<?php echo e(route('loginpage')); ?>">Login</a>
            </div>
        </div>
    </div>
</nav>
    ...
    <section class="py-5">
          ...
          <h3 class="mb-5">Top 3 Most Sold Cars</h3>
              ...
              <?php $__currentLoopData = $topCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topCar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

              <div style="width:350px;" class="col mb-5">
                      <div class="card h-100">
                          <!-- Product image-->
                          <img height="180" src="<?php echo e(asset('storage/carscontainer/' . $topCar->image)); ?>" alt="Image">
                          <!-- Product details-->
                          <div class="card-body p-4">
                              <div class="text-center">
                                  <!-- Product name-->
                                  <h5 class="fw-bolder"><?php echo e($topCar->model_name); ?></h5>
                                  <!-- Prod   uct price-->
                                  <span>$<?php echo e($topCar->price); ?></span>
                          ...
                          <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                              <div class="text-center">
                                  <a  class="btn btn-outline-dark mt-auto" href="<?php echo e(route('cardetial',['id' => $topCar->inventory_id])); ?>">View options</a>
                              </div>
                          </div>
                      </div>
                  </div>
...
<?php /**PATH C:\laragon\www\CarManagementSystem\resources\views/welcome.blade.php ENDPATH**/ ?>