...
<html lang="en">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?php echo e(route('dealers')); ?>">Dealers</a></li>
    ...
    <form action="<?php echo e(route('storeCar')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="mb-3">
        ...
        <select name="model_id" class="form-select" aria-label="Default select example">
            ...
            <option value="<?php echo e($model->model_id); ?>"><?php echo e($model->name); ?></option>
...
<?php /**PATH C:\laragon\www\CarManagementSystem\resources\views/pages/cars.blade.php ENDPATH**/ ?>